  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between mb-4">
        ...
        {onViewDetails && (
          <span className="flex items-center gap-0.5 text-xs text-blue-400 font-semibold">
      ...
      {result.hasEnoughData ? (
        ...
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1">
            <p className="text-sm font-bold text-slate-200 mb-1">Build Your Moneo Score</p>
