...
function RowButton({
  ...
  return (
    <button
      ...
      style={{ borderBottom: noBorder ? 'none' : '1px solid #0c1a30' }}
    >
  ...
  const Toggle = ({ on, onToggle }: { on: boolean; onToggle: () => void }) => (
    ...
    >
      <div className="absolute inset-0 rounded-full transition-all"
        style={{ background: on ? 'rgba(59,130,246,0.8)' : 'rgba(30,45,74,1)', border: '1px solid ' + (on ? 'rgba(59,130,246,0.5)' : '#1e2d4a') }} />
    ...
    <div className="page-enter px-4 pt-3 pb-8 space-y-5">
      ...
      <div>
        ...
        <div className="card-dark rounded-2xl overflow-hidden">
          ...
          {/* Avatar + email header */}
          <div className="flex items-center gap-3.5 px-4 pt-4 pb-3" style={{ borderBottom: '1px solid #0c1a30' }}>
          ...
          <div className="px-4 py-3" style={{ borderBottom: '1px solid #0c1a30' }}>
            ...
            <div className="flex items-center gap-2">
              ...
              <input
                ...
                style={{ background: '#07101f', border: '1px solid #0f1e38' }}
              />
            </div>
      ...
      <div>
        ...
        <div className="card-dark rounded-2xl overflow-hidden">
          ...
          <button
            ...
            style={{ borderBottom: '1px solid #0c1a30' }}
          >
            <div className="w-9 h-9 rounded-xl flex items-center justify-center flex-shrink-0"
          ...
          {showLangPicker && (
            <div className="px-4 pb-3 pt-2 grid grid-cols-2 gap-2" style={{ borderBottom: '1px solid #0c1a30' }}>
              {LANGUAGES.map(l => (
                <button
                  key={l.code}
          ...
          {/* App notifications */}
          <div className="flex items-center gap-3.5 px-4 py-3.5" style={{ borderBottom: '1px solid #0c1a30' }}>
            <div className="w-9 h-9 rounded-xl flex items-center justify-center flex-shrink-0"
      ...
      <div>
        ...
        <div className="card-dark rounded-2xl overflow-hidden">
          ...
          {showChangePwd && (
            <div className="px-4 py-3 space-y-2.5" style={{ borderBottom: '1px solid #0c1a30' }}>
              {pwdSuccess ? (
      ...
      <div>
        ...
        <div className="card-dark rounded-2xl overflow-hidden">
          ...
          {showAbout && (
            <div className="px-4 py-3 space-y-1" style={{ borderBottom: '1px solid #0c1a30' }}>
