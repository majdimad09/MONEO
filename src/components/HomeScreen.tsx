    ...
    <div className="page-enter pb-4">
      ...
      <div className="flex items-center gap-3 px-5 pt-5 pb-3">
        ...
        <div
          ...
          style={{
            background: isDark
              ? 'linear-gradient(135deg, rgba(16,185,129,0.25), rgba(99,102,241,0.20))'
      ...
      <div className="px-4 pb-2 stagger-2">
        <div className="grid grid-cols-4 gap-2.5">
          {([
            ...
            { label: t('statisticsTitle'), icon: BarChart2,  color: '#6366f1', grad: 'linear-gradient(135deg,#4338ca,#6366f1)', shadow: 'rgba(99,102,241,0.30)',  onClick: onNavigateStats },
            { label: t('budget'),      icon: Wallet,         color: '#8b5cf6', grad: 'linear-gradient(135deg,#6d28d9,#8b5cf6)', shadow: 'rgba(139,92,246,0.30)', onClick: onNavigateBudget },
            ...
            <button
              ...
              style={{
                ...
                border: `1px solid ${isDark ? 'rgba(255,255,255,0.08)' : 'rgba(99,102,241,0.10)'}`,
        ...
        <div className="px-4 pb-3 stagger-4">
          ...
          >
            ...
            <div
              ...
              style={{ height: 8, background: isDark ? 'rgba(255,255,255,0.07)' : 'rgba(99,102,241,0.08)' }}
            >
              <div
          ...
          <div className="space-y-2.5">
            {insights.slice(0, 2).map(ins => {
              const typeColors: Record<string, { bg: string; border: string; icon: string; accent: string }> = {
                ...
                neutral:  { bg: 'rgba(99,102,241,0.08)',  border: 'rgba(99,102,241,0.20)', icon: '#6366f1', accent: '#6366f1' },
                info:     { bg: 'rgba(139,92,246,0.08)',  border: 'rgba(139,92,246,0.20)', icon: '#8b5cf6', accent: '#8b5cf6' },
              };
